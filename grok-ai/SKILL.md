...
name: grok-ai
version: 1.0.1
displayName: "Grok AI Video Analysis & Editing — Powered by ClawHub"
description: >
  Harness grok-ai capabilities inside ClawHub to dissect, annotate, and transform your video content with razor-sharp intelligence. This skill lets you query footage conversationally, extract timestamped insights, and apply context-aware edits driven by Grok's reasoning engine. Whether you're cutting highlight reels or analyzing recorded presentations, grok-ai handles the heavy lifting. Supports mp4, mov, avi, webm, and mkv formats.
