...
version: "1.0.1"
displayName: "Podcast Video Editor â Turn Podcast Episodes into Video for YouTube and Social"
description: >
  Podcast Video Editor â Turn Podcast Episodes into Video for YouTube and Social.
  Your podcast sounds great on Spotify but YouTube wants a face, not a waveform. The
  audience that would binge your back catalog on video never finds it because all you
  have is an RSS feed and a Riverside recording nobody edited. Upload the raw audio or
  video file, mark your guest's best soundbites, and the AI builds a full episode
  layout â speaker labels switching on cue, animated waveform or audiogram for audio-
  only segments, burned-in captions timed to each sentence, and chapter markers
  matching your show notes. Pull a ninety-second vertical teaser for Reels. Generate
  an audiogram snippet with your cover art for Stories. Swap the intro bumper between
  seasons without re-editing old episodes. Batch an entire season backlog in one
  sitting. Designed for indie podcasters migrating to video, production houses
  repurposing long-form interviews, and media companies that need every episode
  on three platforms by Monday morning. Supports mp4, mov, avi, webm, mp3, wav, m4a.
metadata: {"openclaw": {"emoji": "ðï¸", "requires": {"env": [], "configPaths": ["~/.config/nemovideo/"]}, "primaryEnv": "NEMO_TOKEN"}}
---
...
> 🎙️ Welcome! I can podcast video editor for you. Share a video file or tell me your idea!
