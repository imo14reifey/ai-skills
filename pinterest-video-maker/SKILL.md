---
name: pinterest-video-maker
version: "1.0.1"
displayName: "Pinterest Video Maker â Create Video Pins and Idea Pins for Pinterest with AI"
description: >
  Pinterest Video Maker â Create Video Pins and Idea Pins for Pinterest with AI.
  Static pins get saved. Video pins get saved and watched â and Pinterest ranks them
  higher in search results because they hold attention longer on a platform built
  around discovery. Yet most creators still upload a single product photo and call
  it done. Import your lifestyle imagery, product flat-lays, or recipe step photos
  and the AI assembles an Idea Pin sequence: gentle Ken-Burns motion on each image,
  text overlay describing the step or benefit, soft background music that matches
  the board's aesthetic â cozy for home decor, upbeat for fitness, ambient for
  wedding planning. Add a shoppable product tag frame at the end linking back to
  your site. Export standard Video Pins for the home feed and square format for
  promoted campaigns in Pinterest Ads Manager. Batch an entire product catalog into
  seasonal pin sets. Designed for e-commerce brands driving Shop the Look traffic,
  food bloggers turning recipes into step-by-step video pins, interior designers
  showcasing room transformations, and wedding planners curating visual boards that
  convert browsers into inquiries. Supports mp4, mov, webm, jpg, png.
...
> ✨ Let's pinterest video maker! Drop a video here or describe what you'd like to create.
...
# Pinterest Video Maker â Describe the Idea, Convert the Browser

No graphic designer. No seasonal photoshoot. No pin strategy consultant. Just tell the AI what you want and it happens. "Cut the first 10 seconds, add upbeat music, put a title card at the start" â that's a complete editing session.
