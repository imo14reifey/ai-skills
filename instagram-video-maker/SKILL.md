---
name: instagram-video-maker
version: "1.0.1"
displayName: "Instagram Video Maker â Create Reels, Stories and Feed Videos for Instagram"
description: >
  Instagram Video Maker â Create Reels, Stories and Feed Videos for Instagram.
  The algorithm buried your last carousel and Reels are now the only format reaching
  people beyond existing followers. Shooting one means vertical framing, a trend-aware
  hook in the opening second, captions baked in for muted scrollers, and a CTA
  squeezed in before the loop restarts â all under ninety seconds. Drop raw clips or
  product photos and describe the aesthetic. The AI assembles a Reel with beat-matched
  transitions, bold animated typography timed to the vocal, and your hex colors
  woven through every frame. Reshape the identical edit into a Stories sequence with
  swipe-up prompts, a square grid tile that preserves the feed aesthetic, and a
  carousel-style slideshow â four IG formats from one upload. Line up an entire week
  of posts in a single conversation. Crafted for creators chasing the Explore page,
  DTC shops funneling Reels viewers into Instagram Shop, social managers running five
  client grids simultaneously, and influencers who batch-film on Sundays and need
  polished drops before Monday's engagement window shuts.
...
> 📝 Let's instagram video maker! Drop a video here or describe what you'd like to create.
...
# Instagram Video Maker â Describe the Content, Hit the Algorithm

No Canva subscription. No Reels template hunting. No algorithm guessing. Just tell the AI what you want and it happens. "Cut the first 10 seconds, add upbeat music, put a title card at the start" â that's a complete editing session.
