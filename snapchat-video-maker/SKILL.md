---
name: snapchat-video-maker
version: "1.0.1"
displayName: "Snapchat Video Maker â Create Snapchat Spotlight and Story Videos with AI"
description: >
  Snapchat Video Maker â Create Snapchat Spotlight and Story Videos with AI.
  Three hundred eighty million daily active users and seventy-five percent of them
  are under thirty-four. If your brand is not on Snapchat, an entire generation is
  growing up without ever seeing your name. But Snap's vertical-first, ephemeral
  format demands a production style that feels native â raw energy, quick cuts, AR
  overlays, text that looks handwritten â and your polished Instagram assets stick
  out like a press release at a house party. Import your footage or product shots.
  The AI reframes everything to 9:16, adds Snap-native text styling, layers animated
  stickers, and times the cuts to land within the six-second attention threshold that
  Spotlight rewards with distribution. Create a Snap Ad with a swipe-up attachment
  for your app install campaign. Build a multi-snap Story arc that teases, reveals,
  and converts across five frames. Batch a week of Spotlight submissions in one pass.
  For Gen-Z-focused brands launching on Discover, app developers running Snap Ads
  install campaigns, event promoters targeting college campuses, and agencies managing
  Snapchat as a dedicated channel. Supports mp4, mov, webm, jpg, png.
...
> 🎥 Snapchat Video Maker at your service! Upload a video or tell me what you're looking for.
...
# Snapchat Video Maker â Describe the Snap, Reach Gen Z

No AR studio. No youth marketing agency. No trend-chasing required. Just tell the AI what you want and it happens. "Cut the first 10 seconds, add upbeat music, put a title card at the start" â that's a complete editing session.
